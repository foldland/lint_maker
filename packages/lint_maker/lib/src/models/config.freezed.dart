...
/// Preset options.
 Map<String, Object> get preset;/// Path of the output file.
///
...
@useResult
$Res call({
 Map<String, Object> preset, String output
});
...
/// Create a copy of Configuration
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? preset = null,Object? output = null,}) {
  return _then(Configuration(
preset: null == preset ? _self.preset : preset // ignore: cast_nullable_to_non_nullable
as Map<String, Object>,output: null == output ? _self.output : output // ignore: cast_nullable_to_non_nullable
as String,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( Map<String, Object> preset,  String output)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Configuration() when $default != null:
return $default(_that.preset,_that.output);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( Map<String, Object> preset,  String output)  $default,) {final _that = this;
switch (_that) {
case _Configuration():
return $default(_that.preset,_that.output);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( Map<String, Object> preset,  String output)?  $default,) {final _that = this;
switch (_that) {
case _Configuration() when $default != null:
return $default(_that.preset,_that.output);case _:
  return null;
...
class _Configuration implements Configuration {
  const _Configuration({required  Map<String, Object> preset, this.output = 'analysis_options.yaml'}): _preset = preset;
  factory _Configuration.fromJson(Map<String, dynamic> json) => _$ConfigurationFromJson(json);

/// Preset options.
 final  Map<String, Object> _preset;
/// Preset options.
@override Map<String, Object> get preset {
  if (_preset is EqualUnmodifiableMapView) return _preset;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableMapView(_preset);
}
...
/// Create a copy of Configuration
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? preset = null,Object? output = null,}) {
  return _then(_Configuration(
preset: null == preset ? _self._preset : preset // ignore: cast_nullable_to_non_nullable
as Map<String, Object>,output: null == output ? _self.output : output // ignore: cast_nullable_to_non_nullable
as String,
  ));
}
